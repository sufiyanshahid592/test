		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="row profile-details">
					...
					<div class="col-lg-6">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 profile-details-label">Height:</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 profile-details-value"><?php echo $get_proposal_details_by_id[0]['height']; ?></div>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="row">
